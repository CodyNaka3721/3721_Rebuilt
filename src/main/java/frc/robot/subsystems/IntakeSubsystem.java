...
public class IntakeSubsystem extends SubsystemBase {
  ...
  private SparkMax intake_ = new SparkMax(Constants.IntakeConstants.kRollerMotorId, MotorType.kBrushless);
  ...
  private SmartMotorController smc = new SparkWrapper(intake_, DCMotor.getNEO(1), smcConfig);
  ...
  private SmartMotorController intakePivotController = new TalonFXWrapper(pivotMotor, DCMotor.getFalcon500(1),
      intakePivotSmartMotorConfig);

  private final ArmConfig intakePivotConfig = new ArmConfig(intakePivotController)
      .withSoftLimits(Degrees.of(0), Degrees.of(105))
      .withHardLimit(Degrees.of(0), Degrees.of(110))
